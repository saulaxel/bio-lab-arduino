...
namespace get_up_test
{

static const char GETPOSE[] = "get_up_test/getPose";

  class getPoseRequest : public ros::Msg
  {
    public:
      typedef const char* _get_up_mode_type;
      _get_up_mode_type get_up_mode;
    ...
    {
      int offset = 0;
      uint32_t length_get_up_mode = strlen(this->get_up_mode);
      varToArr(outbuffer + offset, length_get_up_mode);
      offset += 4;
      memcpy(outbuffer + offset, this->get_up_mode, length_get_up_mode);
      offset += length_get_up_mode;
      union {
        int64_t real;
        uint64_t base;
      } u_robot_pose;
    ...
    {
      int offset = 0;
      uint32_t length_get_up_mode;
      arrToVar(length_get_up_mode, (inbuffer + offset));
      offset += 4;
      for(unsigned int k= offset; k< offset+length_get_up_mode; ++k){
          inbuffer[k-1]=inbuffer[k];
      }
      inbuffer[offset+length_get_up_mode-1]=0;
      this->get_up_mode = (char *)(inbuffer + offset-1);
      offset += length_get_up_mode;
      union {
        int64_t real;
        uint64_t base;
    ...
    const char * getMD5(){ return "e44557e533586d12bcc59b38acfabe3c"; };
