#ifndef _ROS_SERVICE_CalculateDK_h
#define _ROS_SERVICE_CalculateDK_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char CALCULATEDK[] = "ctrl_msgs/CalculateDK";

  class CalculateDKRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return CALCULATEDK; };
    const char * getMD5(){ return "50b3293f6e585f2a02888f333d3c3e8a"; };

  };

  class CalculateDKResponse : public ros::Msg
  {
    public:
  ...
  class CalculateDK {
    public:
    typedef CalculateDKRequest Request;
    typedef CalculateDKResponse Response;
  };
